...
create(
  ...
  try {
    const dto = new CreateHolidayCalendarDto();
  } catch (e) {
  ...
  @Put(':id')
  update(@Param('id') id: string, @Body() data: UpdateHolidayCalendarDto): Promise<HolidayCalendar> {
    return this.service.update(id, data);
  }

  @Delete(':id')
  remove(@Param('id') id: string): Promise<HolidayCalendar> {
    return this.service.delete(id);
  }


  @Get()
findAll(@Query() query: QueryHolidayCalendarDto) {
